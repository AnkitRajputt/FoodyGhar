...
public final class ActivityFaqBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView faq;

  private ActivityFaqBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView faq) {
  ...
  public static ActivityFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.faq;
      RecyclerView faq = ViewBindings.findChildViewById(rootView, id);
      if (faq == null) {
        break missingId;
      }

      return new ActivityFaqBinding((LinearLayout) rootView, faq);
    }
